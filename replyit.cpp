...
int main()
{
   ...
   system("color e");
   cout<<"\n\n";
   cout<<"\t====================STUDENT RECORD CARD MANEGEMENT SYSTEM===================="<<endl;
   cout<<endl;
   cout<<"\t\t\t\t1. MAIN MENU\n\n";
   cout<<"\t\t\t\t2. EXIT\n\n";
...
void gmrksht(int n)
{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tC++ MARK :"<<s.cpp<<endl<<endl;
        cout<<"\t\t\t\tJAVA MARK :"<<s.java<<endl<<endl;
...
void modifyStud(int n)
{
    ...
    if(infile.fail())
    {
     ...
     infile.read(reinterpret_cast<char*>(&s),sizeof(student));
     {
         ...
         {
        cout<<"\t\t\t\tSTUDENT NAME :"<<s.name<<endl<<endl;
        cout<<"\t\t\t\tC++ MARKS :"<<s.cpp<<endl<<endl;
        cout<<"\t\t\t\tJAVA MARKS :"<<s.java<<endl<<endl;
        cout<<"\t\t\t\tWRITING SKILL MARKS :"<<s.writing<<endl<<endl;
        cout<<"\t\t\t\tALGEBRA MARKS :"<<s.alg<<endl<<endl;
        cout<<"============================================="<<endl;
